"""
    @package
    Generate an HTML Xling-specific BOM list.
    Components are sorted and grouped by value
    Fields are (if exist)
    Ref, Quantity, Value, Part, Footprint, Description, Vendor, Model

    Command line:
    python "pathToFile/xling-bom-generator.py" "%I" "%O.html"
"""
...
row += "<th>Description</th>" + "<th>Vendor</th>" + "<th>Model</th></tr>"
...
for group in grouped:
    ...
    row += "</td><td>" + c.getField("Model") + "</td></tr>"
